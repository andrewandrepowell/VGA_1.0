# Runtime Tcl commands to interact with - VGA_v1_0

# Sourcing design address info tcl
set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
source ${bd_path}/VGA_v1_0_include.tcl
...
# Test: m_axi_fb
set wdata_m_axi_fb [get_init_data 0]
create_hw_axi_txn w_m_axi_fb_addr [get_hw_axis $jtag_axi_master] -type write -address $axi_gpio_out_addr -data ${wdata_m_axi_fb}
create_hw_axi_txn r_m_axi_fb_addr [get_hw_axis $jtag_axi_master] -type read -address $axi_gpio_in_addr 
# Initiate transactions
run_hw_axi r_m_axi_fb_addr
run_hw_axi w_m_axi_fb_addr
run_hw_axi r_m_axi_fb_addr
set rdata_tmp [get_property DATA [get_hw_axi_txn r_m_axi_fb_addr]]
set DE [ get_done_and_error_bit $rdata_tmp 1 0 ]
# Compare read data
if { $DE == 01 } {
	puts "Data comparison test pass for - m_axi_fb"
} else {
	puts "Data comparison test fail for - m_axi_fb, rdata-$rdata_tmp expected-01 actual-$DE"
	inc ec
}
